  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form className='flex flex-col gap-4'>
        ...
        <img onClick={()=>fileRef.current.click()} className='rounded-full h-24 w-24 object-cover cursor-pointer self-center mt-1' 
        ...
        <input type="password" placeholder='password' id='password' className='border p-3 rounded-lg ' />
         <button className='bg-slate-700 text-white rounded-lg p-3 uppercase hover:opacity-05 disabled:opacity-80'>Update</button>
      </form>
